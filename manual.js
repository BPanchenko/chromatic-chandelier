...
"short"in e&&"domain"in e,"isSpaceDimension");function m(e,r,o){
let a=Iterator.from(o===void 0?[e,r]:[e,r,o]),s=o===void 0?2:
3;for(let p of a.take(s))if(se(p)===!1)throw new TypeError("\
Passed wrong space dimension: "+JSON.stringify(p,void 0,2));
let c=a.take(s).filter(p=>p.tgeom==="azimuth"||p.tgeom==="re\
ference-ray").toArray().length===2?s===3?"cilinder":"circle":
s===3?"cube":"plane",u=Object.create(null,{0:{enumerable:!0,
value:e},1:{enumerable:!0,value:r},length:{enumerable:!0,value:s},
...
return s===3&&Object.defineProperty(u,2,{enumerable:!0,value:o}),
p=>p===void 0?u:Object.defineProperties(u,p)}t(m,"O");A(m,"c\
...
o,a]=r,s=a-o,c=o+s/2;return Object.create(null,{from:{value:o},
to:{value:a},minimum:{enumerable:!0,value:o},maximum:{enumerable:!0,
value:a},avg:{enumerable:!0,value:c},value:{enumerable:!0,value:s},
allot:{value:E},clamp:{value:X},test:{value:C(u=>o<=u&&u<=a,
...
this.value}t(E,"p");C(E,"allocateOuterValue");function X(e){
return this.test(e)?e:Math.max(Math.min(e,this.to),this.from)}
t(X,"h");C(X,"restrictOuterValue");var ce=Object.defineProperty,ue=t((e,r)=>ce(e,"name",{value:r,
...
of(0,e[0]):Array.of(Math.min(...e),Math.max(...e)),[o,a]=r,s=a-
o,c=o+s/2;return Object.create(null,{from:{value:o},to:{value:a},
minimum:{enumerable:!0,value:o},maximum:{enumerable:!0,value:a},
avg:{enumerable:!0,value:c},value:{enumerable:!0,value:s},allot:{
value:Z},clamp:{value:U},test:{value:v(u=>o<=u&&u<=a,"value")},
...
L,"createRange");function Z(e){return this.test(e)?e:e>this.
from?(e-this.to)%this.value+this.from:this.to-(this.from-e)%
this.value}t(Z,"f");v(Z,"allocateOuterValue");function U(e){
return this.test(e)?e:Math.max(Math.min(e,this.to),this.from)}
t(U,"S");v(U,"restrictOuterValue");function D(e=[0,100],r=[0,
1]){let[o,a]=r,[s,c]=e,[u,p]=[a-o,c-s];function w(l){return typeof l==
"string"&&(l=parseFloat(l)),Y.domain.test(l)===!1&&(l=l>a?(l-
a)%u+o:a-(o-l)%u),p*(l-o)/u+s}t(w,"p"),v(w,"invert");function Y(l){
return typeof l=="string"&&(l=parseFloat(l)),Y.range.test(l)===
!1&&(l=l>c?(l-c)%p+s:c-(s-l)%p),u*(l-s)/p+o}return t(Y,"c"),
v(Y,"calculator"),Object.defineProperties(Y,{domain:{enumerable:!0,
value:L(o,a)},range:{enumerable:!0,value:L(s,c)},invert:{enumerable:!0,
...
(${u})?$`,"i");if(p.test(e)){let w=p.exec(e)?.slice(1)??["0",
"deg"];r=parseFloat(w[0]),o=w[1]}else if(e==="none")r=NaN;else
throw new TypeError("Expected a valid <angle> string")}let[a,
s]=o==="grad"?[0,400]:o==="deg"?[0,360]:o==="rad"?[-Math.PI,
Math.PI]:[0,1],c=i(a,s);return c.test(r)===!1&&(r=c.allot(r)),
...
rho",tcoord:"polar",tgeom:"reference-ray"});var W=Object.freeze({$coord:f,bytes:4,description:"Chroma: t\
he quality of a color's purity, intensity or saturation.",domain:i(
0,100),ident:"saturation",input:t(e=>e/100,"input"),output:t(
e=>n(e*100,2),"output"),short:"S"});var _e=m(f,j)({adapt:{enumerable:!0,value:G}});function G(e=0,r=NaN){let o=e*Math.cos(r),a=e*Math.sin(r);return[
o,a]}t(G,"calcCartesianCoordinates");var R=m(f,j,d)({adapt:{value:he}});function he(e){let[r,o,a]=e,[s,c]=G(r,o);return[s,c,a]}t(he,
"calcCubeCoordinates");var h=Float64Array.of(.9504559270516716,1,1.0890577507598784);
Object.freeze(h.buffer);var bt={CAM:m(S,W,g)(),CSYS:R,ident:"hsl",whitepoint:h};var q=Object.freeze({$coord:d,bytes:4,description:"Blackness\
...
r model, similar to HSL and HSV.",CAM:m(S,V,q)(),CSYS:R,ident:"\
...
.4),input:t(e=>e,"input"),output:t(e=>n(e*.4,5),"output")});var _t=m(O,x)({adapt:{value:F}});function F(e,r){let o=0,a=NaN;return(e!==0||r!==0)&&(o=Math.
sqrt(e**2+r**2),e!==0&&!r||r!==0&&!e?a=r/Math.abs(r)*(Math.PI/
2):a=Math.atan(r/e)),[o,a]}t(F,"calcPolarCoordinates");var y=m(O,x,d)({adapt:{value:be}});function be(e){let[r,o,a]=e,[s,c]=F(r,o);return[s,c,a]}t(be,
"calcCylindricalCoordinates");var b=Float64Array.of(.9642956764295677,1,.8251046025104602);
Object.freeze(b.buffer);var br=Object.freeze({CAM:m(g,N,$)(),CSYS:y,description:"CIE\
...
's purity, intensity or saturation."});var Mr={CAM:m(g,Q,S)(),CSYS:R,description:"CIE-based LCh col\
or spaces are transformations of the two chroma values (ab o\
r uv) into the polar coordinate.",ident:"lch",whitepoint:b};var Nr=Object.freeze({CAM:m(g,T,J)(),CSYS:y,ident:"oklab",whitepoint:b});var Zr={CAM:m(g,_,S)(),CSYS:R,ident:"oklch",whitepoint:b};var ee=Object.freeze({$coord:d,bytes:4,domain:i(0,100),ident:"\
...
e=>e/255,"input"),output:t(e=>K.domain.clamp(Math.round(e*255)),
"output"),short:"R",description:"Red Light Intensity"});var ho=Object.freeze({CAM:m(K,k,H)(),CSYS:y,ident:"rgb",whitepoint:h});var P=m(re,te,ee)(),z=y,M=h,xo=Object.freeze({ident:"srgb",CAM:P,
...
br as LABModel,Mr as LCh,Nr as OKLAB,Zr as OKLCh,Po as ProphotoRGBSpace,
