...
"n"),hr=wt(t=>t!==null&&typeof t=="object"&&Array.isArray(t)===!1,
"isObject"),yr=wt(t=>hr(t)&&"ident"in t&&"short"in t&&"domain"in t,
"isSpaceDimension");function z(t,r,e){let i=Iterator.from(e===void 0?
[t,r]:[t,r,e]),n=e===void 0?2:3;for(let m of i.take(n))if(yr(m)===
...
a,m)}o(z,"w");wt(z,"createCoordinateSystem");var gr=Object.defineProperty,ct=o((t,r)=>gr(t,"name",{value:r,configurable:!0}),
"n"),eo=ct(t=>typeof t=="number","isNumber"),ur=ct(t=>t!==null&&typeof t==
"object"&&Array.isArray(t)===!1,"isObject"),Vr=ct(t=>ur(t)&&Symbol.
...
OuterValue");var zr=Object.defineProperty,Sr=o((t,r)=>zr(t,"name",{value:r,configurable:!0}),
"n");var Pr=Sr((t,r=6)=>{let e=10**r;return Math.sign(t)*Math.round((Math.
abs(t)+Number.EPSILON)*e)/e},"round"),u=Pr;var wr=Object.defineProperty,xt=o((t,r)=>wr(t,"name",{value:r,configurable:!0}),
...
enumerable:!0,value:n},allot:{value:ko},clamp:{value:Mo},test:{value:xt(
...
teRange");function ko(t){return this.test(t)?t:t>this.from?(t-this.
to)%this.value+this.from:this.to-(this.from-t)%this.value}o(ko,"g");
xt(ko,"allocateOuterValue");function Mo(t){return this.test(t)?t:
Math.max(Math.min(t,this.to),this.from)}o(Mo,"h");xt(Mo,"restrict\
...
n,p)},invert:{enumerable:!0,value:l}})}o(no,"F");xt(no,"initScale");var po=no([0,360],[-Math.PI,Math.PI]),vt=Object.freeze({bytes:8,domain:po.
...
t"),short:"S"});var ke=z(nt,vt)({adapt:{enumerable:!0,value:ao}});function ao(t=0,r=NaN){return[t*Math.cos(r),t*Math.sin(r)]}o(ao,"\
calcCartesianCoordinates");var gt=z(nt,vt,it)({adapt:{value:vr}});function vr(t,r,e){return[
...ao(t,r),e]}o(vr,"calcCubeCoordinates");var q=Object.defineProperty(Float64Array.of(.9504559270516716,1,1.0890577507598784),
...
.4),ident:"green-red",short:"a"});var mt=Object.freeze({bytes:8,domain:d(-1,1),ident:"ordinate",short:"\
...
.4),ident:"blue-yellow",short:"b"});var wi=z(_t,mt)({adapt:{value:_o}});function _o(t,r){let e=0,i=NaN;return(t!==0||r!==0)&&(e=Math.sqrt(
t**2+r**2),t!==0&&!r||r!==0&&!t?i=r/Math.abs(r)*(Math.PI/2):i=Math.
atan(r/t)),[e,i]}o(_o,"calcPolarCoordinates");var dt=z(_t,mt,it)({adapt:{value:kr}});function kr(t,r,e){return[
..._o(t,r),e]}o(kr,"calcCylindricalCoordinates");var L=Object.defineProperty(Float64Array.of(.9642956764295677,1,.8251046025104602),
...
0,.4),output:o(t=>u(t,5),"output"),bytes:4});var Wo=Object.freeze({CAM:z(at,Xo,bt)(),CSYS:gt,ident:"lch",whitepoint:L});var Tt=Object.freeze({CAM:z(at,Oo,jo)(),CSYS:dt,ident:"oklab",whitepoint:q});var jt={CAM:z(at,Zo,bt)(),CSYS:gt,ident:"oklch",whitepoint:q};var Bo=Object.freeze({$coord:it,bytes:4,domain:d(0,100),ident:"bl\
...
t*255)),"output"),short:"B"});var Eo=Object.freeze({$coord:mt,bytes:4,domain:d(0,100),ident:"gr\
...
t*255)),"output"),short:"R"});var kt=z(Ro,Eo,Bo)(),St=dt,Mt=q,D=Object.freeze({ident:"srgb",CAM:kt,
...
CSYS:St,whitepoint:Mt}),fo=Object.freeze({ident:"display-p3",CAM:kt,
CSYS:St,whitepoint:Mt}),co=Object.freeze({ident:"prophoto-rgb",CAM:kt,
CSYS:St,whitepoint:L}),xo=Object.freeze({ident:"rec2020",CAM:kt,CSYS:St,
whitepoint:Mt}),Lo=Object.freeze({ident:"rgb",CAM:z(so,lo,mo)(),CSYS:St,
whitepoint:Mt});var j=Object.freeze({ident:"xyz-d65",CSYS:dt,whitepoint:q}),X=Object.
...
ct"&&Array.isArray(t)===!1,"isObject"),Dn=ht(t=>Ir(t)&&"length"in
...
n,p,i);return n}o(y,"v");ht(y,"createMatrix");var Cr=Object.defineProperty,w=o((t,r)=>Cr(t,"name",{value:r,configurable:!0}),
"t"),Ar=w(t=>typeof t=="string","isString"),ho=w(t=>bo(t)&&Symbol.
iterator in t&&typeof t[Symbol.iterator]=="function","isIterableO\
bject"),bo=w(t=>t!==null&&typeof t=="object"&&Array.isArray(t)===
!1,"isObject"),Or=w(t=>Ar(t)&&jr.has(t),"isSpaceID"),Tr=w(t=>bo(t)&&
"ident"in t&&Or(t.ident)&&"CSYS"in t&&bo(t.CSYS)&&"length"in t.CSYS&&
t.CSYS.length===3,"isColorSpace"),jr=new Set(["a98-rgb","display-\
p3","hsl","hwb","lab","lch","oklab","oklch","prophoto-rgb","rec20\
20","srgb-linear","srgb","rgb","xyz","xyz-d50","xyz-d65"]),Xr=w(t=>ho(
t)&&"length"in t&&typeof t.length=="number"&&t.length>=9,"isMatri\
x"),Zr=w(t=>ho(t)&&"space"in t&&Tr(t.space)&&"length"in t&&t.length===
3&&Iterator.from(t).every(r=>typeof r=="number"),"isPointInSpace"),
Wr=w(t=>ho(t)&&"length"in t&&t.length===3&&"multiply"in t&&typeof t.
multiply=="function","isVector");function c(t,r=0,e=0){let i=Zr(t)?
...
from(this.toArray())},"value")}}),n}o(c,"G");w(c,"createVector");
function Do(t){for(let r=0;r<3;r++)t(this[r],r,this);return this}
o(Do,"A");w(Do,"each");function No(t){let[r,e,i]=this.head;if(Xr(
t)||Wr(t)){let[n,p,a,m=0,l=0,f=0,x=0,J=0,I=0]=t;return this.update(
r*n+e*m+i*x,r*p+e*l+i*J,r*a+e*f+i*I)}else throw new TypeError("Un\
supported Multiplicator: "+t)}o(No,"V");w(No,"multiply");var Br=Object.defineProperty,N=o((t,r)=>Br(t,"name",{value:r,configurable:!0}),
"t"),Er=N(t=>typeof t=="number","isNumber"),Rr=N(t=>typeof t=="st\
ring","isString"),Ho=N(t=>yo(t)&&Symbol.iterator in t&&typeof t[Symbol.
iterator]=="function","isIterableObject"),yo=N(t=>t!==null&&typeof t==
"object","isObject"),Lr=N(t=>Rr(t)&&Dr.has(t),"isSpaceID"),Go=N(t=>yo(
t)&&"ident"in t&&Lr(t.ident)&&"CSYS"in t&&yo(t.CSYS)&&"length"in t.
...
s=N(t=>Ho(t)&&"space"in t&&Go(t.space)&&"length"in t&&t.length===
3&&Iterator.from(t).every(r=>typeof r=="number"),"isPointInSpace");
function _(t,r){if(Go(t)===!1)throw new TypeError("Point must be \
...
from(m),"get")}});for(let l=0;l<a.length;l++)(function(f,x,J){Object.
defineProperty(a,l,{enumerable:!0,get(){let{CAM:I,CSYS:ft}=this.space,
Ot=ft[x],yt=I!==void 0?I[f]:null,pt=J[x];return"output"in Ot&&typeof Ot.
output=="function"&&(pt=Ot.output(pt)),yt!==null&&"output"in yt&&
typeof yt.output=="function"&&(pt=yt.output(pt)),pt},set(I){let{CAM:ft,
CSYS:Ot}=this.space,yt=Ot[x],pt=ft!==void 0?ft[f]:null;pt!==null&&
"input"in pt&&typeof pt.input=="function"&&(I=pt.input(I)),"input"in
yt&&typeof yt.input=="function"&&(I=yt.input(I)),typeof I=="strin\
g"&&(I=parseFloat(I)),J[x]=I}})})(l,n[l],m)})(p,i),Object.defineProperties(
...
e")}}),Ho(r)?p.set(r):p}o(_,"X");N(_,"initPointInSpace");var lt=o(t=>{let r=Math.abs(t);return r<=.04045?t/12.92:Math.sign(
...
.06325924320057072,.021041441191917323,1.330365926242124);var $o=y(608311/1250200,35783/156275,0,189793/714400,247089/357200,
32229/714400,198249/1000160,198249/2500400,5220557/5000800),G=o(t=>{
if(s(t)&&t.colorspace==="display-p3"){let[r,e,i]=t.position,[n,p,
a]=c(r,e,i).each((m,l,f)=>f[l]=lt(m)).multiply($o);return _(j,[n,
p,a])}else throw new Error("Wrong parameter passed: "+t)},"displa\
y_p3_into_xyz_d65"),Vo=o(t=>{if(s(t)&&t.colorspace==="display-p3"){
let[r,e,i]=t.position,[n,p,a]=c(r,e,i).each((m,l,f)=>f[l]=lt(m)).
multiply($o).multiply(H);return _(X,[n,p,a])}else throw new Error(
...
t");var Fo=y(1829569/896150,-851781/878810,16779/1248040,-506331/896150,
1648619/878810,-147721/1248040,-308931/896150,36519/878810,1266979/
1248040),Z=o(t=>{if(s(t)&&t.colorspace==="xyz-d65"){let[r,e,i]=t.
position,[n,p,a]=c(r,e,i).multiply(Fo).each((m,l,f)=>f[l]=uo(m)*100);
...
Fo).each((m,l,f)=>f[l]=uo(m)*100);return _(Xt,[n,p,a])}else throw new Error(
"Wrong parameter passed: "+t)},"xyz_d50_into_a98_rgb");var up=o(t=>Z(G(t)),"display_p3_into_a98_rgb");var Uo=y(573536/994567,591459/1989134,53769/1989134,263643/1420810,
6239551/9945670,351524/4972835,187206/994567,374412/4972835,4929758/
4972835),$=o(t=>{if(s(t)&&t.colorspace==="a98-rgb"){let[r,e,i]=t.
position,[n,p,a]=c(r,e,i).each((m,l,f)=>f[l]=go(m)).multiply(Uo);
return _(j,[n,p,a])}else throw new Error("Wrong parameter passed:\
 "+t)},"a98_rgb_into_xyz_d65"),Ko=o(t=>{if(s(t)&&t.colorspace==="\
a98-rgb"){let[r,e,i]=t.position,[n,p,a]=c(r,e,i).each((m,l,f)=>f[l]=
go(m)).multiply(Uo).multiply(H);return _(X,[n,p,a])}else throw new Error(
"Wrong parameter passed: "+t)},"a98_rgb_into_xyz_d50");var Bt=y(12831/3959,-851781/878810,705/12673,-329/214,1648619/878810,
-2585/12673,-1974/3959,36519/878810,705/667),E=o(t=>{if(s(t)&&t.colorspace===
"xyz-d65"){let[r,e,i]=t.position,[n,p,a]=c(r,e,i).multiply(Bt).each(
...
i).multiply(Bt).each((m,l,f)=>f[l]*=100);return _(Pt,[n,p,a])}else
throw new Error("Wrong parameter passed: "+t)},"xyz_d65_into_srgb\
_linear"),ut=o(t=>{if(s(t)&&t.colorspace==="xyz-d50"){let[r,e,i]=t.
position,[n,p,a]=c(r,e,i).multiply(A).multiply(Bt).each((m,l,f)=>f[l]=
st(m)*100);return _(D,[n,p,a])}else throw new Error("Wrong parame\
ter passed: "+t)},"xyz_d50_into_srgb"),Et=o(t=>{if(s(t)&&t.colorspace===
"xyz-d50"){let[r,e,i]=t.position,[n,p,a]=c(r,e,i).multiply(A).multiply(
Bt).each((m,l,f)=>f[l]*=100);return _(Pt,[n,p,a])}else throw new Error(
"Wrong parameter passed: "+t)},"xyz_d50_into_srgb_linear");var Rt=o(t=>E($(t)),"a98_rgb_into_srgb"),Lp=o(t=>ot($(t)),"a98_rg\
b_into_srgb_linear");var Lt=o(t=>E(G(t)),"display_p3_into_srgb"),$p=o(t=>ot(G(t)),"dis\
...
to_rgb"),Jo=o(t=>{if(s(t)&&t.colorspace==="hsl"){let[r,e,i]=t.position,
...
_into_xyz_d50"),It=o(t=>{let r=M(t),[e,i,n]=c(r).multiply(A);return _(
j,[e,i,n])},"lab_into_xyz_d65");var Dt=o(t=>ut(M(t)),"lab_into_srgb"),va=o(t=>Et(M(t)),"lab_into_\
...
lch_into_lab");var Nt=o(t=>ut(M(R(t))),"lch_into_srgb"),Xa=o(t=>Et(M(R(t))),"lch\
_into_srgb_linear");var qo=y(1,1,1,.3963377773761749,-.1055613458156586,-.0894841775298119,
...
[n,p,a]=c(i,r,e).multiply(qo).each((m,l,f)=>f[l]=m**3).multiply(Qo);
return _(j,[n,p,a])}else throw new Error("Wrong parameter passed:\
 "+t)},"oklab_into_xyz_d65"),Ht=o(t=>{let[r,e,i]=c(g(t)).multiply(
H);return _(X,[r,e,i])},"oklab_into_xyz_d50");var Gt=o(t=>E(g(t)),"oklab_into_srgb"),Ua=o(t=>ot(g(t)),"oklab_in\
...
rameter passed: "+t)},"oklch_into_oklab");var $t=o(t=>E(g(U(t))),"oklch_into_srgb"),n_=o(t=>ot(g(U(t))),"ok\
lch_into_srgb_linear");var tr=o(t=>{let r=Math.abs(t);return r<=.03125?t/16:Math.sign(t)*
...
toArray());return c(r).each((e,i,n)=>n[i]=tr(e)).multiply(Nr),r}else
throw new Error("Wrong parameter passed: "+t)},"prophoto_rgb_into\
_xyz_d50"),tt=o(t=>{let r=Zt(t),e=_(j,r.position.toArray());return c(
e).multiply(A),e},"prophoto_rgb_into_xyz_d65");var Vt=o(t=>E(tt(t)),"prophoto_rgb_into_srgb"),u_=o(t=>ot(tt(t)),
"prophoto_rgb_into_srgb_linear");var Ft=1.09929682680944,or=.018053968510807,So=o(t=>{let r=Math.abs(
t);return r<or*4.5?t/4.5:Math.sign(t)*Math.pow((r+Ft-1)/Ft,1/.45)},
"to_linear"),Po=o(t=>{let r=Math.abs(t);return r>or?Math.sign(t)*
(Ft*Math.pow(r,.45)-(Ft-1)):4.5*t},"to_gamut");var rr=y(63426534/99577255,26158966/99577255,4994106574466076e-32,
...
each((m,l,f)=>f[l]=So(m)).multiply(rr);return _(j,[n,p,a])}else throw new Error(
"Wrong parameter passed: "+t)},"rec2020_into_xyz_d65"),er=o(t=>{if(s(
t)&&t.colorspace==="rec2020"){let[r,e,i]=t.position,[n,p,a]=c(r,e,
i).each((m,l,f)=>f[l]=So(m)).multiply(rr).multiply(H);return _(X,
[n,p,a])}else throw new Error("Wrong parameter passed: "+t)},"rec\
2020_into_xyz_d50");var Ut=o(t=>E(V(t)),"rec2020_into_srgb"),X_=o(t=>ot(V(t)),"rec202\
...
"Wrong parameter passed: "+t)},"srgb_into_xyz_d50"),ir=o(t=>{if(s(
...
near_into_a98_rgb");var sm=o(t=>Jt(Jo(t)),"hsl_into_a98_rgb");var ym=o(t=>{if(s(t)&&t.colorspace==="hwb"){let[r,e,i]=t.position;
if(r+i>=1){let n=r/(r+i);return _(Xt,[n,n,n])}else{let n=Q(e,1,.5).
map(p=>(p*(1-r-i)+r)*100);return Jt(_(D,n))}}else throw new Error(
"Wrong parameter passed: "+t)},"hwb_into_a98_rgb");var Pm=o(t=>Z(It(t)),"lab_into_a98_rgb");var Ym=o(t=>Z(It(R(t))),"lch_into_a98_rgb");var jm=o(t=>Z(g(t)),"oklab_into_a98_rgb");var nr=o(t=>Ht(U(t)),"oklch_into_xyz_d50"),pr=o(t=>g(U(t)),"oklch\
_into_xyz_d65");var Nm=o(t=>Z(pr(t)),"oklch_into_a98_rgb");var Fm=o(t=>Z(tt(t)),"prophoto_rgb_into_a98_rgb");var Qm=o(t=>Z(V(t)),"rec2020_into_a98_rgb");var ar=y(446124/178915,-14852/17905,11844/330415,-333277/357830,63121/
35810,-50337/660830,-72051/178915,423/17905,316169/330415),W=o(t=>{
if(s(t)&&t.colorspace==="xyz-d65"){let[r,e,i]=t.position,[n,p,a]=c(
r,e,i).multiply(ar).each((m,l,f)=>f[l]=st(m)*100);return _(fo,[n,
p,a])}else throw new Error("Wrong parameter passed: "+t)},"xyz_d6\
5_into_display_p3"),qt=o(t=>{if(s(t)&&t.colorspace==="xyz-d50"){let[
r,e,i]=t.position,[n,p,a]=c(r,e,i).multiply(A).multiply(ar).each(
(m,l,f)=>f[l]=st(m)*100);return _(fo,[n,p,a])}else throw new Error(
"Wrong parameter passed: "+t)},"xyz_d50_into_display_p3");var wl=o(t=>W($(t)),"a98_rgb_into_display_p3");var _r=o(t=>{if(s(t)&&t.colorspace==="hsl"){let[r,e,i]=t.position,
...
assed: "+t)},"hsl_into_xyz_d65");var Xl=o(t=>W(rt(t)),"hsl_into_display_p3");var mr=o(t=>{if(s(t)&&t.colorspace==="hwb"){let[r,e,i]=t.position,
...
100),p=_(D,n);return T(p)}else throw new Error("Wrong parameter p\
assed: "+t)},"hwb_into_xyz_d65");var $l=o(t=>W(et(t)),"hwb_into_display_p3");var Jl=o(t=>qt(M(t)),"lab_into_display_p3");var es=o(t=>qt(M(R(t))),"lch_into_display_p3");var _s=o(t=>W(g(t)),"oklab_into_display_p3");var xs=o(t=>W(g(U(t))),"oklch_into_display_p3");var gs=o(t=>W(tt(t)),"prophoto_rgb_into_display_p3");var ws=o(t=>W(V(t)),"rec2020_into_display_p3");var Ys=o(t=>W(T(t)),"srgb_into_display_p3"),Cs=o(t=>W(K(t)),"srgb\
_linear_into_display_p3");var v=o((t,r,e)=>{let i=Math.max(t,r,e),n=Math.min(t,r,e),p=i-n,a=lr(
t,r,e),m=0,l=(n+i)/2;return p!==0&&(m=l===0||l===1?0:(i-l)/Math.min(
l,1-l)),m<0&&(a+=Math.PI,m=Math.abs(m)),m<=1e-5&&(a=NaN),[a*180/Math.
PI,m*100,l*100]},"rgb_to_hsl"),lr=o((t,r,e)=>{let i=Math.max(t,r,
e),n=Math.min(t,r,e),p=NaN,a=i-n;if(a!==0){switch(i){case t:p=(r-
e)/a+(r<e?6:0);break;case r:p=(e-t)/a+2;break;case e:p=(t-r)/a+4}
p*=Math.PI/3}return p},"rgb_to_hue"),k=o((t,r,e)=>{let i=lr(t,r,e),
...
_into_hsl");var kf=o(t=>{let[r,e,i]=Nt(t).position;return _(S,v(r,e,i))},"lch\
...
_d50_into_hsl"),dc=o(t=>{let[r,e,i]=E(t).position;return _(S,v(r,
e,i))},"xyz_d65_into_hsl");var Xc=o(t=>{let[r,e,i]=Rt(t).position;return _(P,k(r,e,i))},"a98\
_rgb_into_hwb");var Dc=o(t=>{let[r,e,i]=Lt(t).position;return _(P,k(r,e,i))},"dis\
play_p3_into_hwb");var Uc=o(t=>{if(s(t)&&t.colorspace==="hsl"){let[r,e,i]=t.position,
[n,p,a]=Q(e,r,i);return _(P,k(n,p,a))}else throw new Error("Wrong\
 parameter passed: "+t)},"hsl_into_hwb");var rx=o(t=>{let[r,e,i]=Dt(t).position;return _(P,k(r,e,i))},"lab\
_into_hwb");var mx=o(t=>{let[r,e,i]=Nt(t).position;return _(P,k(r,e,i))},"lch\
_into_hwb");var dx=o(t=>{let[r,e,i]=Gt(t).position;return _(P,k(r,e,i))},"okl\
ab_into_hwb");var Px=o(t=>{let[r,e,i]=$t(t).position;return _(P,k(r,e,i))},"okl\
ch_into_hwb");var Cx=o(t=>{let[r,e,i]=Vt(t).position;return _(P,k(r,e,i))},"pro\
photo_rgb_into_hwb");var Wx=o(t=>{let[r,e,i]=Ut(t).position;return _(P,k(r,e,i))},"rec\
...
"srgb-linear"){let[r,e,i]=t.position.map(n=>st(n));return _(P,k(r,
e,i))}else throw new Error("Wrong parameter passed: "+t)},"srgb_l\
inear_into_hwb");var qx=o(t=>{let[r,e,i]=ut(t).position;return _(P,k(r,e,i))},"xyz\
_d50_into_hwb"),Qx=o(t=>{let[r,e,i]=E(t).position;return _(P,k(r,
...
t)},"xyz_d65_into_xyz_d50");var sr=o(t=>b(h(t)),"xyz_d65_into_lab"),b=o(t=>{if(s(t)&&t.colorspace===
...
lch");var oh=o(t=>Y(b(t)),"xyz_d50_into_lch"),rh=o(t=>Y(sr(t)),"xyz_d65\
...
z_d50_into_oklab");var Mh=o(t=>O($(t)),"a98_rgb_into_oklab");var Oh=o(t=>O(G(t)),"display_p3_into_oklab");var Wh=o(t=>{let r=rt(t);return O(r)},"hsl_into_oklab");var Dh=o(t=>O(et(t)),"hwb_into_oklab");var to=o(t=>{let r=M(t),e=Qt(r);return O(e)},"lab_into_oklab");var ty=o(t=>{let r=R(t),e=M(r),i=Qt(e);return O(i)},"lch_into_okl\
...
b_into_oklch");var s5=o(t=>oo(to(t)),"lab_into_oklch");var h5=o(t=>{let r=R(t),e=to(r);return oo(e)},"lch_into_oklch");var S5=o(t=>{let r=tt(t);return F(r)},"prophoto_rgb_into_oklch");var M5=o(t=>{let r=V(t);return F(r)},"rec2020_into_oklch");var O5=o(t=>{let r=T(t);return F(r)},"srgb_into_oklch"),T5=o(t=>{
let r=K(t);return F(r)},"srgb_linear_into_oklch");var fr=y(1.3457868816471583,-.5446307051249019,0,-.25557208737979464,
...
[n,p,a]=c(r,e,i).multiply(H).multiply(fr).each((m,l,f)=>f[l]=zo(m)*
...
"Wrong parameter passed: "+t)},"xyz_d50_into_prophoto_rgb");var ng=o(t=>C(Ko(t)),"a98_rgb_into_prophoto_rgb");var lg=o(t=>C(Vo(t)),"display_p3_into_prophoto_rgb");var cr=o(t=>M(R(t)),"lch_into_xyz_d50"),bg=o(t=>It(R(t)),"lch_int\
o_xyz_d65");var Tg=o(t=>C(_r(t)),"hsl_into_prophoto_rgb");var Bg=o(t=>C(mr(t)),"hwb_into_prophoto_rgb");var Ng=o(t=>C(M(t)),"lab_into_prophoto_rgb");var Fg=o(t=>C(cr(t)),"lch_into_prophoto_rgb");var Qg=o(t=>C(Ht(t)),"oklab_into_prophoto_rgb");var iu=o(t=>C(nr(t)),"oklch_into_prophoto_rgb");var mu=o(t=>C(er(t)),"rec2020_into_prophoto_rgb");var xu=o(t=>C(At(t)),"srgb_into_prophoto_rgb"),bu=o(t=>C(ir(t)),"\
srgb_linear_into_prophoto_rgb");var xr=y(30757411/17917100,-19765991/29648200,792561/44930125,-6372589/
...
"xyz-d50"){let[r,e,i]=t.position,[n,p,a]=c(r,e,i).multiply(A).multiply(
xr).each((m,l,f)=>f[l]=Po(m)*100);return _(xo,[n,p,a])}else throw new Error(
"Wrong parameter passed: "+t)},"xyz_d50_into_rec2020");var Ru=o(t=>B($(t)),"a98_rgb_into_rec2020");var Gu=o(t=>B(G(t)),"display_p3_into_rec2020");var Ku=o(t=>B(rt(t)),"hsl_into_rec2020");var oz=o(t=>B(et(t)),"hwb_into_rec2020");var pz=o(t=>ro(M(t)),"lab_into_rec2020");var fz=o(t=>ro(M(R(t))),"lch_into_rec2020");var hz=o(t=>B(g(t)),"oklab_into_rec2020");var Pz=o(t=>B(g(U(t))),"oklch_into_rec2020");var Iz=o(t=>B(tt(t)),"prophoto_rgb_into_rec2020");var Tz=o(t=>B(T(t)),"srgb_into_rec2020"),jz=o(t=>B(K(t)),"srgb_li\
...
Vb as a98_rgb_into_lch,Mh as a98_rgb_into_oklab,Ly as a98_rgb_into_oklch,
...
Ko as a98_rgb_into_xyz_d50,$ as a98_rgb_into_xyz_d65,up as display_p3_into_a98_rgb,
...
G as display_p3_into_xyz,Vo as display_p3_into_xyz_d50,G as display_p3_into_xyz_d65,
...
Jo as hsl_into_srgb,ra as hsl_into_srgb_linear,rt as hsl_into_xyz,
_r as hsl_into_xyz_d50,rt as hsl_into_xyz_d65,ym as hwb_into_a98_rgb,
$l as hwb_into_display_p3,ff as hwb_into_hsl,V0 as hwb_into_lab,xd as hwb_into_lch,
Dh as hwb_into_oklab,r5 as hwb_into_oklch,Bg as hwb_into_prophoto_rgb,
oz as hwb_into_rec2020,fa as hwb_into_rgb,fa as hwb_into_srgb,ca as hwb_into_srgb_linear,
et as hwb_into_xyz,mr as hwb_into_xyz_d50,et as hwb_into_xyz_d65,
_ as initPointInSpace,s as isPointInSpace,Pm as lab_into_a98_rgb,
...
It as lab_into_xyz,M as lab_into_xyz_d50,It as lab_into_xyz_d65,Ym as lch_into_a98_rgb,
es as lch_into_display_p3,kf as lch_into_hsl,mx as lch_into_hwb,R as lch_into_lab,
...
bg as lch_into_xyz,cr as lch_into_xyz_d50,bg as lch_into_xyz_d65,
...
$t as oklch_into_srgb,n_ as oklch_into_srgb_linear,pr as oklch_into_xyz,
nr as oklch_into_xyz_d50,pr as oklch_into_xyz_d65,Fm as prophoto_rgb_into_a98_rgb,
...
ly as rec2020_into_oklab,M5 as rec2020_into_oklch,mu as rec2020_into_prophoto_rgb,
Ut as rec2020_into_rgb,Ut as rec2020_into_srgb,X_ as rec2020_into_srgb_linear,
V as rec2020_into_xyz,er as rec2020_into_xyz_d50,V as rec2020_into_xyz_d65,
...
K as srgb_linear_into_xyz,ir as srgb_linear_into_xyz_d50,K as srgb_linear_into_xyz_d65,
...
Et as xyz_d50_into_srgb_linear,Qt as xyz_d50_into_xyz_d65,Z as xyz_d65_into_a98_rgb,
W as xyz_d65_into_display_p3,dc as xyz_d65_into_hsl,Qx as xyz_d65_into_hwb,
sr as xyz_d65_into_lab,rh as xyz_d65_into_lch,O as xyz_d65_into_oklab,
F as xyz_d65_into_oklch,tg as xyz_d65_into_prophoto_rgb,B as xyz_d65_into_rec2020,
E as xyz_d65_into_rgb,E as xyz_d65_into_srgb,ot as xyz_d65_into_srgb_linear,
h as xyz_d65_into_xyz_d50,Z as xyz_into_a98_rgb,W as xyz_into_display_p3,
dc as xyz_into_hsl,Qx as xyz_into_hwb,sr as xyz_into_lab,rh as xyz_into_lch,
O as xyz_into_oklab,F as xyz_into_oklch,tg as xyz_into_prophoto_rgb,
B as xyz_into_rec2020,E as xyz_into_rgb,E as xyz_into_srgb,ot as xyz_into_srgb_linear};
